				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						<div class="row">
							...
							<form class="form-horizontal" id="usercreate" role="form">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="fullname" name="fullname" placeholder="Full Name" class="col-xs-10 col-sm-7" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="username" name="username" placeholder="User Name" class="col-xs-10 col-sm-7" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="upassword" name="upassword" placeholder="Password" class="col-xs-10 col-sm-7" />
									</div>
								</div>
								<div class="form-group">
